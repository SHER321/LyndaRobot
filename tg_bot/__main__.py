...
CHANNEL [Our Channel](https://t.me/ALL_MOVIES_LIABRARY)
GROUP [Our Group](https://t.me/MOVIERG_NY)
...
LYNDA_IMG = "https://telegra.ph/file/c93583f60f2f4186ae453.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
Lynda is hosted on one of Digital Ocean Servers. \
You can donate to the original writer of the Base code, Paul
There are two ways of supporting him; [PayPal](paypal)."""
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="👥 Add Dia to your group", url="https://t.me/KINGNGY2tgbot?startgroup=new")],
                [InlineKeyboardButton(text="🙋 Support Group", url="https://t.me/MOVIERG_NY"), InlineKeyboardButton(text="Owner", url="https://t.me/NGYNY")],
